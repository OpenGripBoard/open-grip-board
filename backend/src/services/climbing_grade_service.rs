...
use crate::{commands::create_climbing_grade::CreateClimbingGrade, errors::errors::RepositoryError, repositories::{climbing_grade_repo::ClimbingGradeRepo, crud_repo::CrudRepo}, structs::climbing_grade::ClimbingGrade};
...
impl ClimbingGradeService {
    ...
    pub async fn create_climbing_grade(&self, new_grade: CreateClimbingGrade) -> Result<ClimbingGrade,RepositoryError>{
