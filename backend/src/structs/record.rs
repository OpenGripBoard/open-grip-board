...
impl From<(records::Model, Vec<measurement_points::Model>, grip_types::Model)> for Record {
    fn from(tuple: (records::Model, Vec<measurement_points::Model>, grip_types::Model)) -> Self {
