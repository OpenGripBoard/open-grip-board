...
use crate::{commands::create_climbing_grade::CreateClimbingGrade, dto::{request::new_climbing_grade_dto::NewClimbingGradeDto, response::climbing_grade_dto::ClimbingGradeDto}, services::climbing_grade_service::ClimbingGradeService, structs::climbing_grade::ClimbingGrade};
...
pub async fn create_climbing_grade(service: &State<ClimbingGradeService>, new_climbing_grade_dto: Json<NewClimbingGradeDto>) -> Status {
    match service.create_climbing_grade(CreateClimbingGrade::from(new_climbing_grade_dto.into_inner())).await{
        Ok(_) => Status::Ok,
