...
use crate::{
    ...
    dto::{request::new_gym_dto::NewGymDto, response::gym_dto::GymDto},
    services::{climber_service::ClimberService, gym_service::GymService},
    structs::{climber::Climber, gym::Gym},
};
...
pub async fn post_new_gym(
    service: &State<GymService>,
    new_gym_dto: Json<NewGymDto>,
    climber_service: &State<ClimberService>,
) -> Status {
